...
1. Water wastage due to over-irrigation. & 1. IoT sensors for soil and weather. & An affordable smart farming kit that saves water, increases yield, and helps farmers make better crop decisions. \\ \hline
2. Low crop yield from poor crop choice. & 2. Automatic irrigation system. &  \\ \hline
3. Lack of affordable smart farming tools. & 3. Mobile app with AI-based crop suggestion. &  \\ \hline
\end{tabular}
...
1. Manual irrigation. & 1. 100+ farmers use the system. & A smart farming assistant for every farmer, like a personal digital guide for crops. \\ \hline
2. Expensive imported smart farming systems. & 2. 45\% water savings (estimated). &  \\ \hline
 & 3. 35\% increase in crop yield (estimated). &  \\ \hline
\end{tabular}
...
1. Direct sales to farmers. & 1. IoT hardware (sensors, controllers). & 1. Small and medium farmers. \\ \hline
2. Partnerships with NGOs and government programs. & 2. Mobile app and server hosting. & 2. Agriculture NGOs and government projects. \\ \hline
3. Agriculture supply companies. & 3. Installation and support. &  \\ \hline
\end{tabular}
...
\hline
\textbf{Early Adopters} & \textbf{Revenue Structure} \\ \hline
1. Farmers with 1--4 acres of land. & 1. Selling hardware kits. \\ \hline
2. NGOs running pilot agriculture projects. & 2. Subscription for premium application features. \\ \hline
 & 3. Installation and training services. \\ \hline
\end{tabular}
\end{table}

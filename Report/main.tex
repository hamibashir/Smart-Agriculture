...
\begin{titlepage}
    ...
    % University Logo
    \includegraphics[width=0.25\textwidth]{images/cust-logo.png}
    \vspace{2cm}
    
    % Student Names and Registration Numbers
    {\large
        \begin{tabular}{lc}
            Muhammad Awais & (BSE223112) \\[0.2cm]
            Hamza Bashir & (BSE223108) \\[0.2cm]
    ...
    \vspace{0.3cm}
    {\large Adnan Karamat\par}
    \vspace{1.5cm}
    
    % Semester and Program
    {\large Fall 2025\par}
    \vspace{0.3cm}
    {\large BS Software Engineering\par}
    \vspace{0.3cm}
...
\textbf{Early Adopters} & \multicolumn{2}{p{\dimexpr7.6cm+2\tabcolsep+\arrayrulewidth}|}{\textbf{Revenue Structure}} \\ \hline
1. Farmers with 1--4 acres of land. \newline
2. NGOs running pilot agriculture projects. & \multicolumn{2}{p{\dimexpr7.6cm+2\tabcolsep+\arrayrulewidth}|}{
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\textwidth]{images/Work Breakdown.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\textwidth]{images/Project Timeline.png}
    \caption{Gantt Chart}
    \label{fig:gantt}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/login_screen.jpg}
    \caption{Login Screen UI Design}
    \label{fig:ui_login}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/main_dashboard_screen.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/field_data_screen.jpg}
    \caption{Detailed Sensor Data Page UI Design}
    \label{fig:ui_sensor_detail}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/crop_recommendation_screen.jpg}
    \caption{AI Crop Recommendation Screen UI Design}
    \label{fig:ui_crop_rec}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/irrigation_control_screen.jpg}
    \caption{Irrigation Control Panel UI Design}
    \label{fig:ui_irrigation}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/alerts_screen.jpg}
    \caption{Alerts \& Notifications Screen UI Design}
    \label{fig:ui_alerts}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/profile_screen.jpg}
    \caption{Settings / Profile Page UI Design}

...
\definecolor{testgray}{gray}{0.88}
\usepackage{graphicx}
\usepackage{caption}
\definecolor{captionblue}{HTML}{1F4E79} % Dark blue for captions (like MS Word)
\DeclareCaptionFont{captionblue}{\color{captionblue}}
\captionsetup{font={it,captionblue}}
...
% Custom Item Heading (Fourth-Level Heading)

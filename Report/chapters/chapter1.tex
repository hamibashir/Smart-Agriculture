...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.8cm}|p{3.5cm}|p{2cm}|p{3.5cm}|p{4.5cm}|}
        \hline
        \rowcolor{black}
        \color{white}\textbf{ID} & \color{white}\textbf{Task / Phase} & \color{white}\textbf{Duration} & \color{white}\textbf{Ownership} & \color{white}\textbf{Deliverable} \\ \hline

...
\textbf{AI Model Training Data:} The crop recommendation model was trained on publicly available datasets. Performance may vary for highly localized Pakistani soil conditions without region-specific training data \cite{ali2025soilml}.

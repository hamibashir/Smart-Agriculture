...
\noindent
The report of the project, ``Smart AI Powered Agriculture System'' has been approved based on the following evaluation guideline.
...
% \includepdf[pages=-, pagecommand={\thispagestyle{empty}}]{endmatter/approval.pdf}